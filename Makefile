...
ifdef gpu
ifdef debug
CXXFLAGS   = -static -DWITHGPU -m64  -msse4.1 -Wno-write-strings -g -I. -I$(CUDA)/include
else
CXXFLAGS   = -static -DWITHGPU -m64 -msse4.1 -Wno-write-strings -O3 -I. -I$(CUDA)/include
endif
LFLAGS     = -lpthread -L$(CUDA)/lib64 -lcudart
else
ifdef debug
CXXFLAGS   = -static -m64 -msse4.1 -Wno-write-strings -g -I. -I$(CUDA)/include
else
CXXFLAGS   = -static -m64 -msse4.1 -Wno-write-strings -O3 -I. -I$(CUDA)/include
endif
LFLAGS     = -lpthread
endif
